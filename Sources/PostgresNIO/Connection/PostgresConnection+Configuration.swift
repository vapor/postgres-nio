...
extension PostgresConnection {
    ...
    public struct Configuration: Sendable {
        ...
        ///   - tls: The TLS mode to use.
        public init(establishedChannel channel: some Channel, tls: PostgresConnection.Configuration.TLS, username: String, password: String?, database: String?) {
        ...
        ///   - channel: The `NIOCore/Channel` to use. The channel must already be active and connected to an
        ///     endpoint (i.e. `NIOCore/Channel/isActive` must be `true`).
        public init(establishedChannel channel: some Channel, username: String, password: String?, database: String?) {
