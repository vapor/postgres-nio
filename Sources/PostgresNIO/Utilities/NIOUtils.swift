...
extension ByteBuffer {
    mutating func readInteger<E>(endianness: Endianness = .big, as rawRepresentable: E.Type) -> E?
    where E: RawRepresentable, E.RawValue: FixedWidthInteger {
    ...
    mutating func write<T>(array: [T], closure: (inout ByteBuffer, T) -> Void) {
