...
extension PSQLRowSequence {
    @inlinable
    public func decode<T0: PSQLDecodable, JSONDecoder: PostgresJSONDecoder>(_: (T0).Type, context: PostgresDecodingContext<JSONDecoder>, file: String = #file, line: UInt = #line) -> AsyncThrowingMapSequence<PSQLRowSequence, (T0)> {
        self.map { row in
    ...
    @inlinable
    public func decode<T0: PSQLDecodable, T1: PSQLDecodable, JSONDecoder: PostgresJSONDecoder>(_: (T0, T1).Type, context: PostgresDecodingContext<JSONDecoder>, file: String = #file, line: UInt = #line) -> AsyncThrowingMapSequence<PSQLRowSequence, (T0, T1)> {
        self.map { row in
    ...
    @inlinable
    public func decode<T0: PSQLDecodable, T1: PSQLDecodable, T2: PSQLDecodable, JSONDecoder: PostgresJSONDecoder>(_: (T0, T1, T2).Type, context: PostgresDecodingContext<JSONDecoder>, file: String = #file, line: UInt = #line) -> AsyncThrowingMapSequence<PSQLRowSequence, (T0, T1, T2)> {
        self.map { row in
    ...
    @inlinable
    public func decode<T0: PSQLDecodable, T1: PSQLDecodable, T2: PSQLDecodable, T3: PSQLDecodable, JSONDecoder: PostgresJSONDecoder>(_: (T0, T1, T2, T3).Type, context: PostgresDecodingContext<JSONDecoder>, file: String = #file, line: UInt = #line) -> AsyncThrowingMapSequence<PSQLRowSequence, (T0, T1, T2, T3)> {
        self.map { row in
    ...
    @inlinable
    public func decode<T0: PSQLDecodable, T1: PSQLDecodable, T2: PSQLDecodable, T3: PSQLDecodable, T4: PSQLDecodable, JSONDecoder: PostgresJSONDecoder>(_: (T0, T1, T2, T3, T4).Type, context: PostgresDecodingContext<JSONDecoder>, file: String = #file, line: UInt = #line) -> AsyncThrowingMapSequence<PSQLRowSequence, (T0, T1, T2, T3, T4)> {
        self.map { row in
