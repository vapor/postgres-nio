...
extension Logger {
    ...
    static let psqlNoOp = Logger(label: "psql_do_not_log", factory: { _ in SwiftLogNoOpLogHandler() })
...
extension Logger {
    ...
    func trace(
        ...
        self.log(
            level: .trace, message(), metadata: metadata().representation, source: source(), file: file, function: function, line: line)
    }
    ...
    func debug(
        ...
        self.log(
            level: .debug, message(), metadata: metadata().representation, source: source(), file: file, function: function, line: line)
    }
    ...
    func notice(
        ...
        self.log(
            level: .notice, message(), metadata: metadata().representation, source: source(), file: file, function: function, line: line)
    }
    ...
    func warning(
        ...
        self.log(
            level: .warning, message(), metadata: metadata().representation, source: source(), file: file, function: function, line: line)
    }
    ...
    func error(
        ...
        self.log(
            level: .error, message(), metadata: metadata().representation, source: source(), file: file, function: function, line: line)
    }
    ...
    func critical(
        ...
        self.log(
            level: .critical, message(), metadata: metadata().representation, source: source(), file: file, function: function, line: line)
    }
}
